...
/**
 * abstract client for the pid-Dpsi protocol
 *
 * @author Yufei Wang
 * @date 2023/8/2
 */
public abstract class AbstractPidDpsiClient<T> extends AbstractTwoPartyPto implements PidDpsiClient<T> {
    /**
     * 客户端最大元素数量
     */
    ...
    protected AbstractPidDpsiClient(PtoDesc ptoDesc, Rpc clientRpc, Party serverParty, PidDpsiConfig config) {
