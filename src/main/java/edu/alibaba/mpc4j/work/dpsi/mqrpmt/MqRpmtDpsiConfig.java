...
public class MqRpmtDpsiConfig extends AbstractMultiPartyPtoConfig implements DpsiConfig {
     ...
     * PSI-CA CDP config
     */
    private final BoundIntegralCdpConfig psicaCdpConfig;
    /**
     ...
     * PSD-CA CDP config
     */
    private final BoundIntegralCdpConfig psdcaCdpConfig;
    /**
     * mqRPMT
     */
    ...
    public BoundIntegralCdpConfig getPsicaCdpConfig() {
    ...
    public BoundIntegralCdpConfig getPsdcaCdpConfig() {
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<MqRpmtDpsiConfig> {
        ...
        public Builder(double outputEpsilon, double psicaEpsilon, double psdcaEpsilon) {
            ...
            psicaCdpConfig = new TruncatedDiscreteLaplaceCdpConfig.Builder(psicaEpsilon, 0.0000001, 1, 0, Integer.MAX_VALUE).build();
            MathPreconditions.checkPositive("ε_psdca", psdcaEpsilon);
            maxPsdcaDummySize = getMaxDummySize(psdcaEpsilon);
            psdcaCdpConfig = new TruncatedDiscreteLaplaceCdpConfig.Builder(psdcaEpsilon, 0.0000001, 1, 0, Integer.MAX_VALUE).build();
